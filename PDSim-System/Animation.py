...
def generate_animation(source_path, matrix_width, matrix_height, n_agents, n_iterations, vmax = 100, save_path = 0, frame_rate=24, fixed_z_height=1000, image_size=5, use_surface=False):
   ...
   def animate(i):
      ...
      if use_surface:
         ...
         ax.plot_surface(X, Y, matrices[i], cmap='viridis', vmin=0, vmax = vmax)
         ax.set_zlim(0, fixed_z_height)
      else:
         ax.matshow(matrices[i], cmap='viridis', vmin=0, vmax = vmax)
